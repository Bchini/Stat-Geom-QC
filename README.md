...
an issue layer, safe selective repair and exportable reports (browser view, HTML file, PDF file).
...
4. Select a vector layer. Every *Analysis options* check is enabled by default;
...
| `statgeomqc:report` | Write HTML and/or PDF reports |
